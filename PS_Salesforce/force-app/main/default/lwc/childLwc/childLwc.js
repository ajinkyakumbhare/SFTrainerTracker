...
import Trainer_Offering__c_OBJECT from '@salesforce/schema/Trainer_Offering__c';
import createTrainer from '@salesforce/apex/cONC.createTrainer';
import NAMETRAINER_FIELD from '@salesforce/schema/Trainer_Offering__c.Trainer__c';
...
dateTimeFieldValueEnd;
    ...
    @track Name = NAMECONTACT_FIELD;
    @track Trainer__c = NAMETRAINER_FIELD;
